...
I develop single-cell proteogenomic tools to address the gap between how we measure and predict how drugs work. In particular, I am interested in direct measurements of protein activities across single cells and spatial contexts, to relate to cell behaviors. Key applications include enabling the study of the complex effects of drugs across cell types in tissues, and how sensory systems integrate environmental signals.
