...
Tissues are composed of cell types that each respond differently to external signals. Yet most tools used to study cell signaling are not cell type-specific, and single-cell genomics tools that chart cell types do not measure proteins that actually encode and process signals. I aim to build single-cell proteogenomic tools that integrate direct measurements of protein activities across cell types, to enable a mechanistic and interpretable view of tissue-level signal processing. I am applying these tools to study the governing principles of how cell types integrate external signals, and how tissues respond to drugs. 
