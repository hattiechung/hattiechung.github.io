...
I develop single-cell proteogenomic tools to address the gap between how we measure and predict how drugs work in tissues. In particular, I am interested in tools that measure the dynamic changes in protein signaling states across single cells and spatial contexts that can be applied to study how different cell types in tissues respond to external signals, including drugs.
