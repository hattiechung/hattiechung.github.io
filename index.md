...
I develop single-cell proteogenomic tools to measure cell signaling in tissues. I focus on measurements of protein activities across single cells and spatial contexts to study how different cell types respond to external signals. A key area of interest is to use such methods to create a more interpretable representation and prediction of how drugs work in tissues.
